...
_VAGUE_META = re.compile(
    ...
    r"|(?:I (?:can't|cannot|couldn't) (?:generate|provide|find|create|make))"
    r"|(?:no puedo (?:generar|crear|producir|hacer))"
    r"|(?:no tengo (?:la )?capacidad de (?:generar|crear|producir|hacer))"
    r"|(?:no (?:es posible|soy capaz de|tengo acceso a) (?:generar|crear|producir))"
    r"|(?:como modelo de lenguaje)"
    r"|(?:as an? (?:AI|language model|LLM))"
    r"|(?:no encuentro informaci[oó]n)"
