...
class TestIdeaRefreshTrigger:
    ...
    def test_refresh_triggered_when_interval_elapsed(self):
        ...
        mock_store.refresh.return_value = {"added": {"router_proposals": 0, "router_analysis": 0, "convergence": 0}, "added_total": 0, "constitutional_blocked": 0, "constitutional_unavailable": 0}
